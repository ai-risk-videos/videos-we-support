...
FORMAT_RULE = ("" if IDEA_FORMAT == "title" else
    ...
    "('1000 AI agents were dropped into Minecraft with no instructions and within days invented their own jobs, "
    "elected leaders, collected taxes, and spread a made up religion', not 'In early 2024 a thousand agents...'). "
